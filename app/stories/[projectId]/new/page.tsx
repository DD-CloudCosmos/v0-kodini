...
export default function NewStoryPage({ params }: NewStoryPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createStory(projectId, title, asA, iWantTo, soThat, rationale)

      toast({
        title: "Success",
        description: "User story has been created.",
      })
      ...
      toast({
        title: "Error",
        description: error.message || "Failed to create user story. Please try again.",
        variant: "destructive",
      })
    } finally {
      setIsSaving(false)
    ...
    <div className="container mx-auto py-8">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Add a new user story to your project</p>
        </div>
